<?php if (get_option('irantheme_front_about_little_title') || get_option('irantheme_front_about_title') || get_option('irantheme_front_about_description') || get_option('irantheme_front_about_long_description') || get_option('irantheme_front_about_link') || get_option('irantheme_front_about_img_1') || get_option('irantheme_front_about_img_2') || get_option('irantheme_front_about_img_3')) : ?>
  <!-- About -->
  <section id="about">
    <div class="container">
      <div class="row">
        <div class="col-lg-6" data-aos="fade-left">
          ...
          <aside class="about-content">
            ...
            <a href="<?php echo esc_url(get_option('irantheme_front_about_link')); ?>" class="button-style button-primary">بیشتر<i class="lni lni-chevron-left"></i></a>
          </aside>
        </div>
